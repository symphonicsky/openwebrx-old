...
# sdr play compatible rtl_tcp server
# rsp_tcp -a 0.0.0.0 -s 2000000 -f 160500000
start_rtl_command="rsp_tcp -a 0.0.0.0 -s {samp_rate} -f {center_freq} -E".format(center_freq=center_freq, samp_rate=samp_rate)
